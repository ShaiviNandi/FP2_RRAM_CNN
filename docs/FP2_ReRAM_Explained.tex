...
\textbf{$+14.77$ accuracy points and $13.6\times$ energy efficiency,
simultaneously.}
\end{keybox}
...
dominates. NeuroSim's area figure comes from transistor-level sizing and is
...
\begin{enumerate}[leftmargin=1.4em,itemsep=3pt]
  ...
  \item Tile height becomes free, the ADC drops to 6 bits, and the result is
        $+14.77$ accuracy points and $13.6\times$ energy efficiency at once ---
