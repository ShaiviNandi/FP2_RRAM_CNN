...
#     currently absorbed into what we call the digital ceiling. Pure analysis,
#     no GPU needed.
# -----------------------------------------------------------------------------
stage_b4() {
  echo
...
#     The C++ side already carries our device; the Python wrapper has its OWN
#     --onoffratio which was still at its default of 10 against our 403. That
...
stage_b6() {
  ...
  run b6_neurosim "NeuroSim at on/off ratio 403" \
    python3 "$NS"/Inference_pytorch/inference.py \
      ...
      --onoffratio 403
  echo "   | NOTE: this is VGG8, our numbers are ResNet-18 -- NOT like-for-like."
